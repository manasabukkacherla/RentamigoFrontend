  ...
  useEffect(() => {
    const fetchPropertyDetails = async () => {
      try {
        ...
        const imagesResponse = await axios.get("https://rentamigotech.onrender.com/api/photos/upload-photos", {
          params: { userId },
        });
        ...
        const commercialsResponse = await axios.get(
          "https://rentamigotech.onrender.com/api/properties/property-commercials/user",
          {
            params: { userId },
          }
        );
        ...
        const allPropertiesResponse = await axios.get("https://rentamigotech.onrender.com/api/allproperties/all");
