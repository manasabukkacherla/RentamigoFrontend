...
interface Subscription {
  ...
  const fetchUserDetails = async (userId: string) => {
    try {
      ...
      const response = await fetch(`https://rentamigotech.onrender.com/api/sign/user/${userId}`, {
        method: "GET",
        headers: {
  ...
  try {
    const res  = await fetch(`https://rentamigotech.onrender.comhttps://rentamigotech.onrender.com/api/subscription/${id}`);
  ...
  const handleProfileUpdate = (e: React.FormEvent) => {
    ...
    fetch(`https://rentamigotech.onrender.com/api/sign/user/update/${userId}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const handlePasswordChange = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`https://rentamigotech.onrender.com/api/sign/user/update-password/${userId}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
