...
function Plans() {
  ...
  const fetchSubscriptionPlans = async () => {
    setLoading(true);
    try {
      const response = await fetch("https://rentamigotech.onrender.com/api/subscription");
  ...
  const fetchTokenPackages = async () => {
    setLoading(true);
    try {
      const response = await fetch("https://rentamigotech.onrender.com/api/tokens");
  ...
  const handlePayment = async (
    ...
    try {
      ...
      if (type === "subscription") {
        const response = await fetch(`https://rentamigotech.onrender.com/api/subscription/${id}`);
        if (!response.ok) throw new Error("Failed to fetch subscription plan");
        selectedItem = await response.json();
      } else if (type === "token") {
        const response = await fetch(`https://rentamigotech.onrender.com/api/tokens/${id}`);
      ...
      const orderResponse = await fetch("https://rentamigotech.onrender.com/api/payment/create-order", {
        method: "POST",
        headers: {
      ...
      const options = {
        ...
        handler: async function (response: any) {
          ...
          const saveResponse = await fetch("https://rentamigotech.onrender.com/api/payment/save-payment", {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },
