...
const LeaseOfficeSpaceMain = () => {
  ...
  const handleSubmit = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      console.log('API Endpoint:', 'https://rentamigotech.onrender.com/api/commercial/lease/office-space');

      try {
        // Make API call to create commercial lease office space
        const response = await axios.post(
          `https://rentamigotech.onrender.com/api/commercial/lease/office-space`, // Fixed endpoint path to match backend route
          backendData,
          {
            headers: {
        ...
        if (apiError.response) {
          ...
          if (apiError.response.status === 404) {
            ...
            console.error("API endpoint 'https://rentamigotech.onrender.com/api/commercial/lease/office-space' not found. Please verify the correct endpoint with your backend team.");
          } else {
