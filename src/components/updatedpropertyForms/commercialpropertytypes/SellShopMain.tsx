...
const SellShopMain = () => {
  ...
  //   const geocodingUrl = `https://maps.googleapis.com/mapshttps://rentamigotech.onrender.com/api/geocode/json?latlng=${lat},${lng}&key=${import.meta.env.VITE_GOOGLE_MAPS_API_KEY}`;
  ...
  const handleSubmit = async (e: { preventDefault: () => void; }) => {
    ...
    try {
      ...
      console.log("Request endpoint:", 'https://rentamigotech.onrender.com/api/commercial/sell/shops');

      // Send the data to the backend
      //https://rentamigotech.onrender.com/api/commercial/sell/shops
      const response = await axios.post('https://rentamigotech.onrender.comhttps://rentamigotech.onrender.com/api/commercial/sell/shops', transformedData, {
        headers: {
  ...
  const testApiConnection = async () => {
    try {
      ...
      const response = await axios.get('https://rentamigotech.onrender.com/api/commercial/sell/shops', {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
