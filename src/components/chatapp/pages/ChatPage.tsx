  ...
  useEffect(() => {
    const fetchOtherUser = async () => {
      ...
      try {
        ...
        let response = await fetch(`https://rentamigotech.onrender.com/api/user/${otherUserId}`, {
          headers: {
        ...
        if (!response.ok || !data.user) {
          response = await fetch(`https://rentamigotech.onrender.com/api/employees/${otherUserId}`, {
            headers: {
              Authorization: `Bearer ${sessionStorage.getItem("token")}`,
              "Content-Type": "application/json",
            },
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <img
            src={`https://ui-avatars.comhttps://rentamigotech.onrender.com/api/?name=${displayName}&background=random`}
            alt={displayName}
