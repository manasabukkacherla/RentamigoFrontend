...
const ConversationListPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchConversations = async () => {
      try {
        const response = await fetch(`https://rentamigotech.onrender.com/api/conversation?userId=${userId}`, {
          headers: {
            ...
            return (
              ...
              >
                <div className="flex items-center gap-4">
                  <img
                    src={conv.avatar || `https://ui-avatars.comhttps://rentamigotech.onrender.com/api/?name=${displayName}&background=random`}
                    alt={displayName}
            ...
            <>
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  try {
                    const response = await fetch(`https://rentamigotech.onrender.com/api/conversation/${selectedConversation._id}/status`, {
                      method: "PUT",
                      headers: {
                        "Content-Type": "application/json",
                        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
