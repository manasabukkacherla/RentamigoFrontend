...
const Settings: React.FC = () => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      ...
      try {
        const response = await fetch(`https://rentamigotech.onrender.com/api/sign/employee/${userId}`);
  ...
  const handleProfileUpdate = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`https://rentamigotech.onrender.com/api/sign/employee/update/${userId}`, {
        method: "PUT",
        headers: {
  ...
  const handlePasswordChange = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        `https://rentamigotech.onrender.com/api/sign/employee/update-password/${userId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
