...
const Leads: React.FC = () => {
  ...
  const handleDelete = useCallback((id: string) => {
    ...
    axios
      .delete(`https://rentamigotech.onrender.com/api/enquiry/enquirydel/${id}`)
      .then(() => {
  ...
  useEffect(() => {
    axios
      .get('https://rentamigotech.onrender.com/api/enquiry/enquiries')
      .then(res => {
  ...
  const handleSubmitEnquiry = useCallback(async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post('https://rentamigotech.onrender.com/api/enquiry/enquiry', enquiryForm);
      if (response.data.success) {
        ...
        // Refresh leads list
        const res = await axios.get('https://rentamigotech.onrender.com/api/enquiry/enquiries');
        const data: Lead[] = res.data.data.map((e: any) => ({
          id: e._id,
          name: e.name,
          email: e.email,
