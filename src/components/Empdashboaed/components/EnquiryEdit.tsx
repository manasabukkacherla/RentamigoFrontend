...
export default function EnquiryEdit() {
  ...
  const fetchEnquiry = async () => {
    try {
      const response = await axios.get(`https://rentamigotech.onrender.com/api/enquiry/enquiry/${id}`);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await axios.put(`https://rentamigotech.onrender.com/api/enquiry/enquiry/${id}`, {
        name: enquiry.name,
        email: enquiry.email,
        phone: enquiry.phone,
