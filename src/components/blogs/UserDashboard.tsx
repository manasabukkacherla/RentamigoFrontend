...
const UserDashboard: React.FC = () => {
  ...
  const getUser = async () => {
    try {
      ...
      if (user) {
        ...
        const response = await axios.get(`https://rentamigotech.onrender.com/api/user/${userId}`);
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (user) {
        const userId = JSON.parse(user).id;
        const response = await axios.put(`https://rentamigotech.onrender.com/api/user/${userId}/edit`, {
          editedUser,
        });
        if (response.data.success) {
          console.log(response.data.user);
  ...
  const loadBlogs = async () => {
    try {
      ...
      const response = await axios.get(`https://rentamigotech.onrender.com/api/blog/myBlogs/${author}`);
  ...
  useEffect(() => {
    ...
    const fetchStats = async () => {
      try {
        ...
        if (user) {
          const author = JSON.parse(user).id;
          const response = await axios.get(`https://rentamigotech.onrender.com/api/stats/${author}`);
