...
const BlogDetail: React.FC = () => {
  ...
  useEffect(() => {
    const fetchBlog = async () => {
      if (id) {
        try {
          const response = await axios.get(`https://rentamigotech.onrender.com/api/blog/${id}`)
          if (response.data.success) {
            ...
            if (user) {
              ...
              const res = await axios.get(`https://rentamigotech.onrender.com/api/likes/${id}/liked/${owner}`)
              ...
              const commentsWithLikes = await Promise.all(
                blog.comments.map(async (comment: Comment) => {
                  const likeRes = await axios.get(`https://rentamigotech.onrender.com/api/comments/${comment._id}/liked/${owner}`)
                  return {
                    ...comment,
              ...
              const reviewsWithLikes = await Promise.all(
                blog.reviews.map(async (review: Review) => {
                  const likeRes = await axios.get(`https://rentamigotech.onrender.com/api/reviews/${review._id}/liked/${owner}`)
                  return {
                    ...review,
                    userHasLiked: likeRes.data.liked,
                  }
  ...
  const handleLike = async () => {
    if (id) {
      try {
        ...
        if (user) {
          const owner = JSON.parse(user).id
          const response = await axios.post(`https://rentamigotech.onrender.com/api/likes/${id}`, { userId: owner })
          if (response.data.success) {
            if (post) {
              setPost({
                ...post,
  ...
  const handleDislike = async () => {
    if (id) {
      try {
        ...
        if (user) {
          const owner = JSON.parse(user).id
          const response = await axios.delete(`https://rentamigotech.onrender.com/api/likes/${id}/${owner}`)
          if (response.data.success) {
            if (post) {
              setPost({
                ...post,
  ...
  const handleCommentLike = async (commentId: string) => {
    try {
      ...
      if (comment?.userHasLiked) {
        const response = await axios.delete(`https://rentamigotech.onrender.com/api/comments/${commentId}/likes/${owner}`)
        if (response.data.success) {
          setComments(
            comments.map((c) =>
        ...
        const response = await axios.post(`https://rentamigotech.onrender.com/api/comments/${commentId}/likes`, { userId: owner })
        if (response.data.success) {
          setComments(
  ...
  const handleReviewLike = async (reviewId: string) => {
    try {
      ...
      if (review?.userHasLiked) {
        const response = await axios.delete(`https://rentamigotech.onrender.com/api/reviews/${reviewId}/likes/${owner}`)
        if (response.data.success) {
          setReviews(
            reviews.map((r) =>
        ...
        const response = await axios.post(`https://rentamigotech.onrender.com/api/reviews/${reviewId}/likes`, { userId: owner })
        if (response.data.success) {
          setReviews(
  ...
  const handleAddComment = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (user) {
        ...
        const response = await axios.post(`https://rentamigotech.onrender.com/api/comments/${id}`, Comment)
        if (response.data.success) {
          setNewComment("")
  ...
  const handleAddReview = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (user) {
        ...
        const response = await axios.post(`https://rentamigotech.onrender.com/api/reviews/${id}`, Review)
        if (response.data.success) {
          setNewReview("")
  ...
  const handleDeleteComment = async (commentId: string) => {
    try {
      ...
      const response = await axios.delete(`https://rentamigotech.onrender.com/api/comments/${commentId}`, {
        data: { author },
        headers: {
  ...
  const handleDeleteReview = async (reviewId: string) => {
    try {
      ...
      const response = await axios.delete(`https://rentamigotech.onrender.com/api/reviews/${reviewId}`, {
        data: { author },
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleShare = async (platform: string) => {
    ...
    try {
      ...
      if (shared) {
        try {
          const response = await axios.post(`https://rentamigotech.onrender.com/api/blog/${id}/share`)
