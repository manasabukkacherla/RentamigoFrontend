...
function ForgotPassword({ onBack }: ForgotPasswordProps) {
  ...
  const handleSendOTP = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://rentamigotech.onrender.com/api/forgot-password", {
        method: "POST",
        headers: {
  ...
  const handleVerifyOTP = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("https://rentamigotech.onrender.com/api/verify-otp", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://rentamigotech.onrender.com/api/reset-password", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
