...
function EmployeeLogin({ onSwitchToSignup, onLoginSuccess }: LoginProps) {
  ...
  const handleGoogleSuccess = async (credentialResponse: any) => {
    try {
      ...
      const response = await axios.post("https://rentamigotech.onrender.com/api/loginuser/google", {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post("https://rentamigotech.onrender.com/api/loginuser/emp-login", formData);
      const userData = response.data;
