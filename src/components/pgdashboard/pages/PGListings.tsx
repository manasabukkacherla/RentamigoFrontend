...
const PGListings: React.FC = () => {
  ...
  useEffect(() => {
    const fetchPGs = async () => {
      try {
        const response = await axios.get('https://rentamigotech.onrender.com/api/residential/pgmain');
...
const handleDelete = async (propertyId: string) => {
  ...
  try {
    const response = await axios.delete(`https://rentamigotech.onrender.com/api/residential/pgmain/${propertyId}`);
