    ...
    const fetchPropertyDetails = async () => {
      try {
        ...
        const propertyResponse = await fetch(
          `https://rentamigotech.onrender.comapi/properties/propertyds/${propertyId}`
        );
        ...
        const featuresResponse = await fetch(
          `https://rentamigotech.onrender.comapi/properties/${propertyId}/features`
        );
        ...
        const availabilityResponse = await fetch(
          `https://rentamigotech.onrender.comapi/properties/${propertyId}/availability`
        );
        ...
        const restrictionsResponse = await fetch(
          `https://rentamigotech.onrender.comapi/properties/${propertyId}/restrictions`
        );
