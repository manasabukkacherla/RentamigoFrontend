...
export default function PropertyRegistrationForm({ propertyId }: PropertyRegistrationFormProps) {
  ...
  useEffect(() => {
    const fetchPropertyDetails = async () => {
      try {
        const response = await fetch(`https://rentamigotech.onrender.comapi/property/${propertyId}`);
  ...
  const handleSendOtp = async () => {
    setIsLoading(true);
    try {
      const response = await fetch("https://rentamigotech.onrender.comapi/property/send-otp", {
        method: "POST",
  ...
  const handleVerifyOtp = async () => {
    setIsLoading(true);
    try {
      const response = await fetch("https://rentamigotech.onrender.comapi/property/verify-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          contactNumber: formData.contactNumber,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://rentamigotech.onrender.comapi/property/submit-form", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
