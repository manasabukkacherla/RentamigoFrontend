...
export default function PropertyRegistrationForm({
    ...
    const fetchPropertyDetails = async () => {
      try {
        const response = await fetch(
          `https://rentamigotech.onrender.com/api/properties/propertyds/${propertyId}`
        );
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("https://rentamigotech.onrender.com/api/property/submit-form", {
        method: "POST",
  ...
  const syncLeads = async () => {
    try {
      const syncResponse = await fetch("https://rentamigotech.onrender.com/api/leads/sync-leads", {
        method: "POST",
      });
