...
//     try {
//       const response = await axios.get("https://rentamigotech.onrender.comhttps://rentamigotech.onrender.com/api/employees");
...
//     try {
//       await axios.put(`https://rentamigotech.onrender.comhttps://rentamigotech.onrender.com/api/employees/${id}`, data);
