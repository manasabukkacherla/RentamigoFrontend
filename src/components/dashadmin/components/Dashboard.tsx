...
const [employeeChange, setEmployeeChange] = useState(0);
  ...
  useEffect(() => {
    const fetchRevenue = async () => {
      try {
        const response = await axios.get('https://rentamigotech.onrender.com/api/payment/total-revenue');
    ...
    const fetchActiveEmployees = async () => {
      try {
        const res = await axios.get('https://rentamigotech.onrender.com/api/employees/active-count');
    ...
    const fetchRevenueChange = async () => {
      try {
        const res = await axios.get('https://rentamigotech.onrender.com/api/payment/revenue-change');
        if (res.data.success) {
    ...
    const fetchEmployeeChange = async () => {
      try {
        const res = await axios.get('https://rentamigotech.onrender.com/api/employees/active-change');
        if (res.data.success) {
