...
const TokenForm: React.FC<TokenFormProps> = ({
  ...
  useEffect(() => {
    if (tokenId) {
      fetch(`https://rentamigotech.onrender.com/api/tokens/${tokenId}`)
        .then((res) => res.json())
  ...
  const handleSubmit = async () => {
    try {
      ...
      const url = isEdit
        ? `https://rentamigotech.onrender.com/api/tokens/${formData._id || tokenId}`
        : "https://rentamigotech.onrender.com/api/tokens";
