...
const Employees = () => {
  ...
  const handleEditSubmit = async () => {
    ...
    console.log("🔄 PUT Request to:", `https://rentamigotech.onrender.com/api/employees/${editingEmployee.id}`);
    console.log("🔄 Payload Data:", updatedFields);

    try {
      const response = await fetch(`https://rentamigotech.onrender.com/api/employees/${editingEmployee.id}`, {
        method: "PUT",
        headers: {
  ...
  const handleDeleteEmployee = async (id: string) => {
    ...
    try {
      const response = await fetch(`https://rentamigotech.onrender.com/api/employees/${id}`, {
        method: "DELETE",
      });
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch("https://rentamigotech.onrender.com/api/employees", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
