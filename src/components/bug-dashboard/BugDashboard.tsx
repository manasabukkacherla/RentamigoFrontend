...
const BugDashboard = () => {
  ...
  const loadBugs = async () => {
    ...
    try {
      const response = await axios.get(`https://rentamigotech.onrender.com/api/bug/list`)
  ...
  const handleAcceptBug = async (bug: Bugs) => {
    try {
      ...
      const response = await axios.put(`https://rentamigotech.onrender.com/api/bug/${bug._id}/accept`, {
        isaccepted: true,
      })

      // Also update the status to "in-progress" using the edit endpoint
      await axios.put(`https://rentamigotech.onrender.com/api/bug/${bug._id}/edit`, {
        status: "in-progress",
      })
  ...
  const handleStatusChange = async (report: Bugs, newStatus: "pending" | "in-progress" | "resolved") => {
    ...
    try {
      const response = await axios.put(`https://rentamigotech.onrender.com/api/bug/${report._id}/edit`, { status: newStatus })
