    ...
    const attemptUpload = async (retries = 2): Promise<any> => {
      try {
        return await axios.post(
          'https://rentamigotech.onrender.com/api/residential/media/upload',
          formData,
          {
            headers: {
...
export const deleteResidentialMediaFromS3 = async (
  ...
  try {
    const response = await axios.delete(`https://rentamigotech.onrender.com/api/residential/media/${propertyType}/${propertyId}/${mediaId}`);
...
export const getResidentialMediaFromS3 = async (
  ...
  try {
    const response = await axios.get(`https://rentamigotech.onrender.com/api/residential/media/${propertyType}/${propertyId}`);
