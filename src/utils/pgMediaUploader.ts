    ...
    const attemptUpload = async (retries = 2): Promise<any> => {
      try {
        return await axios.post(
          'https://rentamigotech.onrender.com/api/residential/pg-media/upload',
          formData,
          {
            headers: {
...
export const deletePgMediaFromS3 = async (
  ...
  try {
    const response = await axios.delete(`https://rentamigotech.onrender.com/api/residential/pg-media/${propertyId}/${mediaId}`);
...
export const getPgMediaFromS3 = async (
  ...
  try {
    const response = await axios.get(`https://rentamigotech.onrender.com/api/residential/pg-media/${propertyId}`);
